...
export default function Slider() {
  ...
  const prevSlide = () => {
    ...
    // Slight difference here = if slideIndex stricly = to 1 (because it always start at 1) then go on the last slide
        ...
        return (
          ...
          >
            <img
              ...
              alt="illustration de combats au sabre laser proposés par notre association"
            />
          </div>
        )
      })}
